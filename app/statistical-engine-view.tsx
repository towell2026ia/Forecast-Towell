...
export default function StatisticalEngineView({ supabaseConfigured }: { supabaseConfigured: boolean }) {
  ...
  return <div className="space-y-6">
    ...
    <div className="rounded-2xl border border-amber-200 bg-amber-50 p-4"><div className="flex gap-3"><AlertTriangle className="mt-0.5 size-5 shrink-0 text-amber-700"/><div><p className="text-sm font-semibold text-amber-950">Ejecución reproducible de validación · conexión operativa pendiente</p><p className="mt-1 text-sm leading-6 text-amber-800">Se calculó desde registros normalizados del PRD 01, no desde Excel. 2023 queda fuera por D10 y Pedido se marca insuficiente: Venta y Pedido nunca se sustituyen entre sí.</p></div></div></div>
